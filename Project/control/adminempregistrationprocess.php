...
if(isset($_POST["Submisson"]))
{
    ...
    elseif(preg_match("/[0-9]/",$fname) || preg_match("/[0-9]/",$lname))
    {
        echo "<b> First name and Last name should contain only alphabetical word </b>"."<br>";
        $error = 1;
    }
    ...
    elseif(preg_match("/[\'^£$%&*()}{@#~?><>,|=_+¬-]/",$uname))
    {
        ...
        echo "<b>User Name should not contain special character</b>"."<br>";
        $error = 1;
    }
    else
    {
    ...
    {
        echo "<b>Password must contain only numerical value"."</b><br>";
        $error = 1;
    }
    else
    {
    ...
    {
        echo "<b>Phone number should contain only numerical value</b>"."<br>";
        $error = 1;
    }
    elseif(strlen($phnnum) < 11)
    {
        echo "<b>Phone Number must be 11 characters</b>"."<br>";
        $error = 1;
    }
    elseif(strlen($phnnum) > 11)
    {
